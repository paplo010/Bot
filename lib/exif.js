...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const wr = { a: global.author ? global.author : 'naze-dev', b: data.packname ? data.packname : global.packname ? global.packname : '𖤍𝑷𝑨𝑷𝑳𝑶✘𝑯𝑨𝑮𝑲𝑰𝑵𝑮𖤍؍.َِ🥱👋    * نـــمـبـــر بــابـلـــو: 01063510519   استمتع بالسرقة ؍.َِ🤎 .🧸 .🤎 .', c: data.author ? data.author : global.author ? global.author : 'Papll', d: data.categories ? data.categories : [""], e: data.isAvatar ? data.isAvatar : 0 }
